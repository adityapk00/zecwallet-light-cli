...
use zcash_primitives::consensus::{NetworkUpgrade, Parameters, MAIN_NETWORK};
...
#[cfg(test)]
pub mod tests {
    use super::{get_default_fee, POST_CANOPY_DEFAULT_FEE, PRE_CANOPY_DEFAULT_FEE, ZIP313_GRACE_PERIOD_BLOCKS};
    use zcash_primitives::consensus::{NetworkUpgrade, Parameters, MAIN_NETWORK};
